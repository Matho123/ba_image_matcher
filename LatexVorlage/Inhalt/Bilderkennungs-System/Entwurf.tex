...
Daher wird für das neue Bilderkennungs-System ein Ansatz vorgesehen, der sich die niedrigen Speicherkosten, sowie den schnellen Vergleich von Bildern mit pHash und gleichzeitig auch die Robustheit der feature-based Algorithmen zunutze macht.
...
Der feature-based Algorithmus hat in diesem Entwurf nur Zugriff auf die Bilder, die in der Vorauswahl durch den pHash Algorithmus gesammelt wurden. Daher können nur die Duplikate erkannt werden, die auch durch pHash erkannt wurden. 
