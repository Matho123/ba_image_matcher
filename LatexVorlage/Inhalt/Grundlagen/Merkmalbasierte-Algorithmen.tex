...
\begin{enumerate}
\item Die Schlüsselpunktsuche, bei der nach Koordinaten innerhalb eines Bildes gesucht wird, an denen sich markante Punkte befinden.
\item Die Erstellung von Deskriptoren, die den Bereich um die Schlüsselpunkte beschreiben. Diese sollen später mit Deskriptoren aus anderen Bildern verglichen werden, um gemeinsame Merkmale zu finden. 
\end{enumerate}
