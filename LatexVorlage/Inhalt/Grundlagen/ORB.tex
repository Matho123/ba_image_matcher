...
Um Invarianz gegenüber Auflösungsunterschieden entgegenzuwirken, generiert ORB mehrere niedriger aufgelöste Varianten des Originalbilds. 
...
Gemäß der Orientierung $\theta$ des Schlüsselpunkts wird eine Rotationsmatrix $ R_\theta$ erstellt. Matrix $S$ wird mit der Rotationsmatrix $ R_\theta$ rotiert und ergibt $S_\theta$. 
