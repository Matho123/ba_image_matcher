...
Bei Deskriptoren, die aus dem SIFT-Algorithmus resultieren, wird die Euklidische Distanz genutzt. Die Deskriptoren sind hierbei eine Folge von Gradient-Werten. 
...
\label{sec:BFM}
Um Übereinstimmungen von Merkmalen in zwei Bildern zu finden, werden alle Deskriptoren des ersten Bilds mit allen Deskriptoren des zweiten Bilds verglichen. \cite{matching}

Der Vorteil dieser simplen Herangehensweise ist, dass garantiert die besten Übereinstimmungen gefunden werden. 
